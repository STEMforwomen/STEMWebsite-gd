        ...
        >
          <motion.div className="max-w-3xl">
            ...
            <motion.div className="relative mb-12" variants={itemVariants}>
              ...
              <motion.div
                className="absolute -inset-4 bg-pink-500/20 rounded-lg blur-xl"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <motion.div className="flex flex-wrap justify-center gap-4" variants={itemVariants}>
              ...
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-gray-800 bg-white hover:bg-white/90 hover:text-gray-900 rounded-full flex items-center group"
                >
                  <motion.div
                    className="mr-2 text-[#b91c77]"
              ...
              {/* Botão Entrar na Comunidade - Redesenhado com animações mais sutis */}
              <motion.div
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
              >
                <Button
                  size="lg"
                  className="bg-white hover:bg-white/90 text-[#b91c77] font-medium rounded-full flex items-center gap-2 shadow-md hover:shadow-lg transition-all"
